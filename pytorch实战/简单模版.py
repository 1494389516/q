...
def generate_data(num_samples):
    ...
    y = 2* X + 3 + np.random.randn(num_samples, 1) * 0.1
    return X, y
...
if __name__ == '__main__':
 ...
 optimizer = optim.Adam(generator.parameters(), lr=learning_rate) # Adam优化器
 scheduler = optim.lr_scheduler.StepLR(optimizer, step_size=100, gamma=0.1)  # 添加学习率调度器
# 训练模型
